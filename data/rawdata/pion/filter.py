...
def filter_BESIII_PIp():
    nameexps = ['BESIII_PI_PLUS_2p0000',
                 'BESIII_PI_PLUS_2p2000',
                 'BESIII_PI_PLUS_2p3960',
                 'BESIII_PI_PLUS_2p6444',
                 'BESIII_PI_PLUS_2p9000',
                 'BESIII_PI_PLUS_3p0500',
                 'BESIII_PI_PLUS_3p5000',
                 'BESIII_PI_PLUS_3p6710']
    infile  = 'BESIII/Table_PIp.csv'
    ndata   = [15, 17, 19, 21, 23, 24, 25, 25]
...
# BESIII - inclusive PI-
def filter_BESIII_PIm():
    nameexps = ['BESIII_PI_MINUS_2p0000',
                 'BESIII_PI_MINUS_2p2000',
                 'BESIII_PI_MINUS_2p3960',
                 'BESIII_PI_MINUS_2p6444',
                 'BESIII_PI_MINUS_2p9000',
                 'BESIII_PI_MINUS_3p0500',
                 'BESIII_PI_MINUS_3p5000',
                 'BESIII_PI_MINUS_3p6710']
    infile  = 'BESIII/Table_PIm.csv'
    ndata   = [15, 17, 19, 21, 23, 24, 25, 25]
    cme     = [2.0000, 2.2000, 2.3960, 2.6444, 2.9000, 3.0500, 3.5000, 3.6710] #GeV
    zmin    = 0.011 # to be checked
    zmax    = 0.800 # to be checked 
...
def filter_DELPHI_KA():
    ...
    infile  = 'DELPHI/HEPData-ins473409-v1-Table_18.csv'
    ndata   = 23
    cme     = 91.20 #GeV
    zmin    = 0.011
    zmax    = 0.800
...
def filter_DELPHI_KA_UDS():
    ...
    infile  = 'DELPHI/HEPData-ins473409-v1-Table_34.csv'
    ndata   = 23
    cme     = 91.20 #GeV
    zmin    = 0.011
    zmax    = 0.800
...
def filter_DELPHI_KA_B():
    ...
    infile  = 'DELPHI/HEPData-ins473409-v1-Table_26.csv'
    ndata   = 23
    cme     = 91.20 #GeV
    zmin    = 0.011
    zmax    = 0.800
